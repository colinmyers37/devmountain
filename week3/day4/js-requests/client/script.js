...
function sayHelloChange() {
 sayHelloButton.style.backgroundColor = 'black'
 sayHelloButton.style.color = 'white'
}

sayHelloButton.addEventListener('mouseover', sayHelloChange)
...
sayHelloButton.addEventListener('mouseout', sayHelloBack)
...
function chooseQuery() {
    axios('http://localhost:3000/query-test?q=Colin')
    .then( res =>  {
        console.log(res.data)
    })
}
...
// says we sent more than one query
